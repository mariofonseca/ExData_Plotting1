#Code for constructing the Plot 4
...
workingData$Global_reactive_power<-as.numeric(workingData$Global_reactive_power)
#First Plot
  #Filter Nas
...
#Second Plot
  #Filter Nas
noNas<-!is.na(workingData$Voltage)
plot(workingData$Time[noNas],workingData$Voltage[noNas], xlab = "datetime", ylab= "Voltage", type="l")
...
#Plot the first graphic, setting explicity the y size
...
#Fourth Plot
#Filter Nas
noNas<-!is.na(workingData$Global_reactive_power)
plot(workingData$Time[noNas],workingData$Global_reactive_power[noNas], xlab = "datetime", ylab= "Globa_reactive_power", type="l")
